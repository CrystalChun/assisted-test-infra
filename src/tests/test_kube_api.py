...
from assisted_test_infra.test_infra.utils.kubeapi_utils import get_platform_type, get_ip_for_single_node
...
class TestLateBinding(BaseKubeAPI):
    ...
    def test_late_binding_kube_api_sno(self, unbound_single_node_cluster, unbound_single_node_infraenv):
        ...
        if global_variables.reclaim:
            log.info("=================relcaim set to true")
